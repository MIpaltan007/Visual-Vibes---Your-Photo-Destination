window.onload = function(){
    ...
    .then(function (data){
       ...
       document.getElementById('img_id').innerText =  search_params.get('id');
...
function loadDetail(data){
    ...
    document.getElementById('jaaga').innerText=`Location: ${data.location.name}`;
    }
    ...
    document.getElementById('color_text').innerText = data.color;
     document.getElementById('download_link').href = data.urls.full;
      document.getElementById('download_link').download = data.alt_description;
